...
import 'package:drhibasaade/utilites/helper.dart';
import 'package:drhibasaade/widgets/custom_inkwell_btn.dart';
        ...
        child: Drawer(
          ...
          child: Column(
            ...
            children: [
              ...
              //      Navigator.push(context, MaterialPageRoute(builder: SlideRightToLeft(page: AboutPage()));
                  },
                  child: Row(
                    children: [
